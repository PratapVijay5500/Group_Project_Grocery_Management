...
<?php if($_SESSION['login_type'] != 1): ?>
	<style>
		...
		.nav-inventory,.nav-home ,.nav-sales,.nav-receiving{
...
<?php if($_SESSION['login_type'] != 2): ?>
	<style>
		...
		.nav-home ,.nav-inventory ,.nav-supplier ,.nav-customer ,.nav-categories  ,.nav-sales-status,.nav-receiving-status ,.nav-users ,.nav-product{
			display: block!important;
