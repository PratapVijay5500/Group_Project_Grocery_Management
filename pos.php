...
if(isset($_GET['id'])){
   ...
   if(isset($_POST['issue'])){
	...
	// foreach($id as $idx){
		$query="INSERT INTO sales_list (`id`, `ref_no`, `customer_id`, `issued`, `comment`, `status`  ) VALUES ('','$ref_no','$customer_id','$issued','$comment','$status')";
					...
					<div class="col-md-12">
						<div class="row">
							<div class="form-group col-md-5">
								<label class="control-label">Indentor</label>
...
<div id="tr_clone">
	...
	<tr class="item-row">
		...
		<td>
			<input type="text"  name="issued[]" value="Administrator" class="form-control"readonly>
		</td>
		<td>
